...
public class PSORSSImportConfig extends XMLConfiguration {
	...
	private static Log m_log = LogFactory.getLog(PSORSSImportConfig.class);
	...
	public void loadChannels()
	{
		...
		if(!channelSet.isEmpty())
		{
			...
			while(it.hasNext())
			{
				...
				config.setProxyServerHost(this.getString("channels.channel(" + index + ").proxyServer.host", ""));
				config.setProxyServerPort(this.getString("channels.channel(" + index + ").proxyServer.port", ""));

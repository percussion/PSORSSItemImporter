...
public class PSORSSItemData {
	...
	private Map m_lookupParamValueMap = new HashMap();
	...
	{
		m_dataMap = new PSORSSItemDataMap(m_item);
		m_dataMap.loadFieldData(m_config.getFieldMappingSet());
	}
